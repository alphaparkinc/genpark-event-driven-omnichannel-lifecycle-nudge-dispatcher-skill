# genpark-event-driven-omnichannel-lifecycle-nudge-dispatcher-skill
...
> **GenPark AI Agent Skill** -- Event-driven omnichannel lifecycle nudge dispatcher & SMS push (Klaviyo style)
